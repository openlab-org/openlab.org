...
Discover new open hardware to collaborate on
...
.. code-block:: bash
    ...
    cd openlab
    celery -A openlab.taskapp worker -l info
...
containers.  Please check `cookiecutter-django Docker documentation`_ for more
details how to start all containers.
...
it yourself.  The system is setup with reasonable defaults, including 404
