...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'openlab.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///openlab'),
}
...
ACCOUNT_ADAPTER = 'openlab.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'openlab.users.adapters.SocialAccountAdapter'
...
########## CELERY
INSTALLED_APPS += ['openlab.taskapp.celery.CeleryConfig']
