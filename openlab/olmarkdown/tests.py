...
class TestBaseMarkdown(SimpleTestCase):
    ...
    def test_paragraphs(self):
        result = _ignore_whitespace(markdown_for_object(TEST_PARAGRAPHS, None))
...
class TestTeam(TestCase):
    ...
    def test_markdown(self):
        ...
        result = _ignore_whitespace(self.team.olmarkdown_rendered)
        self.assertEqual(result, TEST_PARAGRAPHS_EXPECTED)
...
TEST_PARAGRAPHS_EXPECTED = _ignore_whitespace('''
<h1>Script</h1> <p>I think we're down to splitting hairs.</p> <table
class="codehilitetable"><tr><td class="linenos"><div class="linenodiv"><pre>1 2
3 4 5 6 7 8 9</pre></div></td><td class="code"><div
class="codehilite"><pre><span></span><span class="kn">import</span> <span
class="nn">sys</span> <span class="k">class</span> <span
class="nc">ExampleClass</span><span class="p">(</span><span
class="nb">object</span><span class="p">):</span>   <span class="k">def</span>
<span class="nf">method</span><span class="p">(</span><span
class="bp">self</span><span class="p">,</span> <span class="n">val</span><span
class="p">,</span> <span class="n">direction</span><span
class="o">=</span><span class="n">DEFAULT</span><span class="p">):</span>
<span class="k">if</span> <span class="n">val</span> <span
class="ow">not</span> <span class="ow">in</span> <span
class="bp">self</span><span class="p">:</span>       <span
class="k">return</span> <span class="bp">None</span>     <span class="c1">#
Logging value</span>     <span class="n">sys</span><span
class="o">.</span><span class="n">stderr</span><span class="o">.</span><span
class="n">log</span><span class="p">(</span><span class="s2">&quot;Testing
statement&quot;</span><span class="p">)</span>     <span
class="k">return</span> <span class="n">val</span> <span class="o">+</span>
<span class="mi">3</span> </pre></div> </td></tr></table> <p>Shields up. <em>I
know</em> I didn't get the wrong room. Tricorders? She could be a fake. We
mentioned that a former member of the crew had come from the colony. And when I
show a glimmer of independent thought, you strap me down, inject me with drugs
and call it a "treatment." Look, I feel the same way, we all do, but if
anything's gonna get done here. That's one trick I didn't even know about.
Data!</p> <p>You think we got their attention, Data? <em>Yes.</em> That's
right. All I have is a vague memory of reading somewhere about someone taking a
shower in his or her clothing. A personal briefing? I told <a
href="http://openlab.org/">OpenLab</a> I'd feed it while he was away.</p>
<h2>Another header</h2> <table> <thead> <tr> <th>First Header</th> <th>Second
Header</th> </tr> </thead> <tbody> <tr> <td>Content Cell</td> <td>Content
Cell</td> </tr> <tr> <td>Content Cell</td> <td>Content Cell</td> </tr> </tbody>
</table> <dl> <dt>Apple</dt> <dd>Pomaceous fruit of plants of the genus Malus
in the family Rosaceae.</dd> <dt>Orange</dt> <dd>The fruit of an evergreen tree
of the genus Citrus.</dd> </dl> <ol> <li>Ordered item 1</li> <li>Ordered item
2</li> </ol> <ul> <li>Unordered item 1</li> <li>Unordered item 2</li> </ul>
<p>A Paragraph. * Not a list item.</p> <ol> <li>Ordered list item. * Not a
separate list item.</li> </ol>
''')
